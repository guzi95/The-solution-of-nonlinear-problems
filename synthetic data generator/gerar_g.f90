...
!A esfera tem raio 5 km, profundidade do centro 7 km e densidade 0.25 g/cm3
...
open (file='dados5.dat', status='old', unit=10, action='read')
...
open (file= 'g_calculado5.dat', unit= 12, status='new', action= 'write')
do i= 1, n
